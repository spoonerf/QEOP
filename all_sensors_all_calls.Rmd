...
all_sensors_df$week<-week(all_sensors_df$hour_rnd)
all_sensors_df$month<-month(all_sensors_df$hour_rnd)
all_sensors_df$year<-year(all_sensors_df$hour_rnd)
...
year_plot<-ggplot(all_sensors_df, aes(x =lubridate::month(hour_rnd, label = TRUE, abbr = TRUE), y = count_ef))+
  geom_boxplot()+
