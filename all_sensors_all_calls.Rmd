...
simulationOutput_pois <- simulateResiduals(fittedModel = fit_zipoisson)
...
simulationOutput_zbin1 <- simulateResiduals(fittedModel = fit_zinbinom1)
...
simulationOutput_zbin2_disp <- simulateResiduals(fittedModel = fit_zinbinom2_disp)
...
simulationOutput_zbin2_disp_mon <- simulateResiduals(fittedModel = fit_zinbinom2_disp_mon)
