...
all_sensors_df_cc$month<-as.factor(all_sensors_df_cc$month_num)
...
# simulationOutput_pois2 <- simulateResiduals(fittedModel = fit_zipoisson, refit = T, n = 20)
# testDispersion(simulationOutput_pois2)
...
fit_zinbinom2_disp_mon_zi <- glmmTMB(count_hour_dep_rnd ~ mean_temp+ 
                              mean_wind + precip_total + 
                             (1|deployment_id),   
                             data = all_sensors_df_cc,   
...
simulationOutput_zbin2_disp_mon_zi <- simulateResiduals(fittedModel = fit_zinbinom2_disp_mon_zi)

testZeroInflation(simulationOutput_zbin2_disp_mon_zi)
testDispersion(simulationOutput_zbin2_disp_mon_zi)

plotResiduals(all_sensors_df_cc$mean_temp, simulationOutput_zbin2_disp_mon_zi$scaledResiduals,quantreg = T)
