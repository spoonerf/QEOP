...
#write.csv(os_sens_df, "all_sensors_os_records.csv", row.names = FALSE)
...
ce_sensors<-data.frame(dump[,c("sensor","datetime","time","prob_bat","species_class","prob_sp" , "date", "time")])
colnames(ce_sensors)<-colnames(os_sens_df)
ce_sensors$sensor_id<- gsub("[^0-9.]", "", ce_sensors$sensor_id)

#write.csv(open_sensors, "all_sensors_ce_records.csv", row.names = FALSE)
